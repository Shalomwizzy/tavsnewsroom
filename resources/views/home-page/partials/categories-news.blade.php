        ...
        <div class="row">
            @foreach($categories as $category)
                <div class="col-lg-6 py-3">
                    ...
                    <div class="swiper carousel-item-2 position-relative">
                        <div class="swiper-wrapper">
                        @foreach($category->postNews as $news)
                            <div
                                class="swiper-slide position-relative category-post-news-item"
                    ...
                    <div class="owl-carousel owl-carousel-3 carousel-item-2 position-relative">
                        @foreach($category->postNews as $news)
                            <div class="position-relative category-post-news-item" style="height: 300px; width: 100%;"> <!-- Fixed height and width -->
                                <img class="img-fluid w-100 h-100" src="{{ asset($news->image_url) }}" style="object-fit: cover;" width="400" height="300" loading="lazy"> <!-- Ensures image covers the entire container -->
