            ...
            <div class="col-lg-6">
                <div class="position-relative mb-3 card" style="height: 400px; width: 100% !important;">
                    ...
                    <img
                        ...
                        src="{{ asset($news->postNews->image_url) }}"                        alt="{{ $news->postNews->headline }} - News Image"
                    ...
                    <div class="overlay position-relative p-3" style="height: 200px !important; background-color: #f8f9fa; color: #222;">
                        <div class="mb-2" style="font-size: 14px; color: #DC143C;">
                            ...
                            <span class="px-1 popu-lates-slash" style="color: #DC143C;">/</span>
                            <span class="reading-time-badge popu-lates-headline" style="color: #DC143C;">
                                <i class="fa fa-clock"></i> {{ $news->postNews->reading_time }} min read
                            </span>
                        </div>
...
{{-- <div class="row mb-3">
    <div class="col-12">
        <div class="d-flex align-items-center justify-content-between bg-light py-2 px-4 mb-3">
            ...
            <a class="text-secondary fw-medium text-decoration-none" href="">View All</a>
        </div>
    </div>
        ...
        @if ($index < 2)
            ...
            <div class="col-lg-6">
                <div class="position-relative mb-3">
                    <img class="img-fluid w-100" src="{{ $news->postNews->image_url }}" style="object-fit: cover;" width="576" height="300" loading="lazy">
        ...
        @else
            ...
            <div class="col-lg-6">
                <div class="d-flex mb-3">
                    <img src="{{ $news->postNews->image_url }}" style="width: 100px; height: 100px; object-fit: cover;" width="100" height="100" loading="lazy">
