                ...
                >
                    ...
                    >
                        ...
                        <span class="reading-time-badge">
                            <i class="fa fa-clock"></i> {{ $news->postNews->reading_time }} min
                        </span>
                    </div>
                    <a 
    ...
    @foreach ($trendingNews as $news)
        @if ($news->section == 'body')
            <div class="d-flex mb-3">
                <img src="{{ asset($news->postNews->image_url) }}" alt="{{ $news->postNews->headline }}" width="100" height="100" style="object-fit: cover;" loading="lazy">
