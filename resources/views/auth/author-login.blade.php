...
@section('meta_title', 'Author Login')
            ...
            <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                <div class="rounded p-4 p-sm-5 my-4 mx-3" style="background:#0d0d0d;">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <span class="text-white fw-semibold">Author Portal</span>
                    </div>
                    ...
                    <form method="POST" action="{{ route('author.login.post') }}">
                        @csrf
                        ...
                        <p class="text-center text-secondary mb-0" style="font-size:.875rem;">
                            Are you an admin? <a href="{{ route('login') }}" style="color:#DC143C;">Admin login</a>
                        </p>
                    </form>
