...
<div class="container admin-view-index">
    <div class="row">
        <div class="col-lg-12">
            ...
            <a href="{{ route('post-news.scheduled') }}" class="btn btn-outline-info btn-sm mb-3 me-2">
                <i class="fa fa-clock"></i> Scheduled Posts
            </a>
            <a href="{{ route('post-news.trash') }}" class="btn btn-outline-danger btn-sm mb-3">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ number_format($post->post_views_count) }}</td>
                            <td>
