...
<!-- Create Author Widget Start -->
<div class="container-fluid pt-4 px-4 pb-4">
    <div class="row g-4">
        <div class="col-sm-12 col-md-6 col-xl-4">
            <div class="h-100 bg-dark rounded p-4">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <h6 class="mb-0 dashboard-h6">Create Author / Admin</h6>
                    <a href="{{ route('users.index') }}" class="dashboad-showall">All Users</a>
                </div>

                @if (session('user_created'))
                    <div class="alert alert-success py-2 mb-3">{{ session('user_created') }}</div>
                @endif
                ...
                <form method="POST" action="{{ route('users.store') }}">
                    ...
                    <div class="mb-2">
                        <input
                            type="text"
                            name="username"
                            class="form-control bg-secondary text-white border-0 @error('username') is-invalid @enderror"
                    ...
                    <div class="mb-2">
                        <select name="role" class="form-select bg-secondary text-white border-0 @error('role') is-invalid @enderror" required>
