    ...
    <div class="email-container">
        ...
        <div class="email-footer">
            ...
            <div style="display: flex; justify-content: center; align-items: center; gap: 10px; flex-wrap: wrap;">
                <a href="{{ $settings['twitter_link'] ?? '#' }}" style="color: #1DA1F2;" target="_blank">
                    <i class="fa-brands fa-square-x-twitter fa-2x"></i>
                </a>
                <a href="{{ $settings['facebook_link'] ?? '#' }}" style="color: #1877F2;" target="_blank">
                    <i class="fab fa-facebook fa-2x"></i>
                </a>
                <a href="{{ $settings['instagram_link'] ?? '#' }}" style="color: #C13584;" target="_blank">
                    <i class="fab fa-instagram fa-2x"></i>
                </a>
                <a href="{{ $settings['linkedin_link'] ?? '#' }}" style="color: #0A66C2;" target="_blank">
            ...
            <div style="text-align: center; margin-top: 20px;">
                <p>&copy; {{ date('Y') }} {{ $settings['site_name'] ?? 'Our Website' }}. All Rights Reserved.</p>
            </div>
        </div>
    </div>
</body>
