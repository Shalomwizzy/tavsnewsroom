<div class="container">
    ...
    <div class="cookie-consent-banner row" role="banner" aria-label="Cookie Consent Banner">
        ...
        <div class="col-md-3 col-4 text-end d-flex justify-content-end align-items-center">
            ...
            <button id="reject-cookies" class="btn btn-link btn-sm ms-2" aria-label="Reject cookies">
                <i class="fas fa-times"></i> Reject
            </button>
            <button id="cancel-cookies" class="btn btn-link btn-sm ms-2" aria-label="Dismiss cookie consent">
