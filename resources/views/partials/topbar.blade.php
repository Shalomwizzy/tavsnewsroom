    ...
    <div class="row align-items-center bg-light px-lg-5  topbar">
        <div class="col-12 col-md-8">
            <div class="d-flex justify-content-between">
                ...
                <!-- Carousel Container -->
                <div class="tranding-carousel-container position-relative d-inline-flex align-items-center ms-3" style="width: calc(100% - 100px); padding-left: 90px; overflow: hidden;">
                    <!-- Bootstrap Carousel for Trending News -->
                    <div id="trendingCarousel" class="carousel slide" data-bs-ride="carousel" data-interval="3000">
