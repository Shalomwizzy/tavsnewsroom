@php
    $authUser    = auth()->user();
    $writerPerms = ($authUser && $authUser->isWriter()) ? ($authUser->permissions ?? []) : [];
    $hasAccess   = fn(string $section) => in_array($section, $writerPerms, true);
@endphp

@if(auth()->check() && ($authUser->isAdmin() || $authUser->isWriter()))
    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-dark navbar-dark">
            ...
            <div class="navbar-nav w-100">
                ...
                @if($authUser->isAdmin() || $hasAccess('home_fixtures'))
                <div>
                ...
                @if($authUser->isAdmin() || $hasAccess('messages'))
                <div>
                ...
                @if($authUser->isAdmin() || $hasAccess('categories'))
                <div>
                ...
                @if($authUser->isAdmin() || $hasAccess('post_news'))
                <div>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0 home-fixtures-items">
                            ...
                            <a href="{{ route('post-news.trash') }}" class="dropdown-item">
                                <i class="fa fa-trash me-1" style="color:#DC143C;"></i> Trash
                            </a>
                        </div>
                    </div>
                </div>
                ...
                @if($authUser->isAdmin() || $hasAccess('mail'))
                <div>
                    <span class="nav-link admin-span">MAIL</span>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle drop-down-write" data-bs-toggle="dropdown"><i class="fa-solid fa-envelope home-fixtures"></i>Mails</a>
                        <div class="dropdown-menu bg-transparent border-0 home-fixtures-items">
                ...
                @if($authUser->isAdmin() || $hasAccess('announcements'))
                <div>
                    <span class="nav-link admin-span">ANNOUNCEMENT</span>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle drop-down-write" data-bs-toggle="dropdown"><i class="fa-solid fa-bullhorn home-fixtures"></i>Announcements</a>
                        <div class="dropdown-menu bg-transparent border-0 home-fixtures-items">
                ...
                <div>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0 home-fixtures-items">
                            @if($authUser->isAdmin() || $hasAccess('analytics'))
                            ...
                            @endif
                            @if($authUser->isAdmin() || $hasAccess('comments'))
                                <a href="{{ route('admin.comments.index') }}" class="dropdown-item">Comments</a>
                            @endif
                        </div>
                    </div>
                </div>
                ...
                @if($authUser->isAdmin() || $hasAccess('footer'))
                <div>
                ...
                @if($authUser->isAdmin() || $hasAccess('management'))
                <div>
        ...
        <nav class="navbar navbar-expand bg-dark navbar-dark sticky-top px-4 py-0">
            ...
            <div class="navbar-nav align-items-center ms-auto">
                ...
                <div class="nav-item me-1">
                    <button id="adminThemeToggle" class="admin-theme-toggle" aria-label="Toggle dark/light mode" title="Switch to Light Mode">
                        <i class="fa fa-sun"></i>
                    </button>
                </div>
