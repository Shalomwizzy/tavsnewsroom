                                        ...
                                        <div class="row">
                                            @foreach ($searchResults as $news)
                                                <div class="col-lg-6 mb-3 seach-result">
                                                    <div class="card">
                                                        <img class="card-img-top" src="{{ asset($news->image_url) }}" alt="{{ $news->headline }}" loading="lazy">
                                                        <div class="card-body">
...
<button
                ...
                <!-- Newsletter End -->
                    ...
                    <!-- Ads Start -->
                    <div class="mb-3 pb-3">
                        <a href="#"><img class="img-fluid" src="{{ asset('path/to/ads.jpg') }}" alt="Advertisement" loading="lazy"></a>
                    </div>
                    <!-- Ads End -->
